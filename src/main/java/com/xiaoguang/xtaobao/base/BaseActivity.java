...
public class BaseActivity extends FragmentActivity {
    ...
    // 开始时间
    private long mStartTime,mStopTime = 0;
    // count down for finish task
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            if(newTask!=null) {
                //暂时设置3秒后进入系统
                mHandler.postDelayed(newTask, mStopTime == 0 ?SHOW_TIME_MIN:mStopTime);
            }
        }
    };
     ...
     * 倒计时
     */
    protected void countDown(Runnable r,int durring){
        newTask = r;
