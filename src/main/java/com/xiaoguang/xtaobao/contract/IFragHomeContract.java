...
public class IFragHomeContract {
    public final static  int NONE_FUNC = 0;
    public final static  int GOODS_TYPE_QUERY_FUNC = 1;
    public final static  int GOODS_NAME_QUERY_FUNC = 2;
    public interface IFragHomeView extends BaseView<IFragHomePresenter> {
         ...
         * @param type 类型 1-9
         */
        void jumpActivity(int type, String datas, int funcType);
